 ...
 *
 * @description If the email domain of the user's email is "mod.connectcircle.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const defaultAvatar =
    "https://raw.githubusercontent.com/alwinvargh/node-projects/refs/heads/main/CommunityCircle/img/dp.jpg";
  ...
  const role = emailDomain === "mod.connectcircle.com" ? "moderator" : "general";
