    ...
    <div className="px-3 py-3 rounded-md border bg-white shadow-2xl shadow-[#f2f5fc] flex justify-between">
      ...
      <div className="">
        <button
          ...
          className="px-2.5 py-2.5 bg-purple-700 shadow-2xl shadow-[#F3F8FF] hover:bg-transparent group hover:border rounded-xl hover:border-purple-700 transition duration-300"
        >
          <MdOutlineGroupAdd className="text-lg text-white group-hover:text-purple-700" />
        </button>
        <JoinModal
