      ...
      <div className="my-4">
        {isModeratorOfThisCommunity && (
          <Link
            ...
            className="px-4 bg-purple-700 text-white shadow-md shadow-gray-50 text-sm py-1 rounded-md flex justify-center items-center w-full my-2 hover:bg-purple-600"
          >
            Moderation Panel
          </Link>
        )}
