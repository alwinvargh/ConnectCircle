    ...
    <div className="bg-white rounded-lg shadow-lg p-8 w-full md:w-96 relative z-10">
      <div className="text-center">
        ...
        <p className="text-gray-700 mb-6">
          ...
          <strong className="text-purple">{communityName}</strong> community may not be the best fit for that audience. However, we believe it would be a great fit for the <strong className="text-purple">{recommendedCommunity}</strong> community!
        </p>

        <button
          className="bg-purple-500 text-sm hover:bg-purple-700 text-white font-semibold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition-colors duration-300"
          onClick={handleClose}
        >
          Got it, thanks!
        </button>
