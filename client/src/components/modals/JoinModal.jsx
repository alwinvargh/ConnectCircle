          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="flex w-full max-w-md transform flex-col items-center overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                  className="flex items-center gap-2 text-xl font-medium leading-6 text-purple-700"
                >
                  <IoIosPeople className="text-base text-purple-700 md:text-xl" />
                  <div className="relative">
                    {community.name}
                    <p className="absolute -right-4 -top-3 flex h-5 w-5 items-center justify-center rounded-full bg-purple-700 text-xs text-white">
