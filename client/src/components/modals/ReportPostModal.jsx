      ...
      <div className="fixed inset-0 flex items-center justify-center">
        ...
        <div className="inline-block align-middle bg-white rounded-md text-left shadow-xl transform transition-all w-full mx-4 md:max-w-lg">
          ...
          <div className="flex justify-end p-4">
            <button
              ...
              className={`inline-flex justify-center px-4 py-2 text-sm font-medium text-white border rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
                isLoading || !reportReason
                  ...
                  : "bg-purple-700 border-transparent hover:bg-purple-600 focus-visible:ring-purple-500"
              }`}
            ...
            <button
              type="button"
              className="inline-flex justify-center px-4 py-2 ml-4 text-sm font-medium text-gray-700 bg-gray-100 border border-transparent rounded-md hover:bg-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-500"
              onClick={onClose}
            >
              Cancel
            </button>
