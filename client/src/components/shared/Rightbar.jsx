            ...
            {visibleCommunities?.map((community) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-purple border border-dashed border-purple-500
                        hover:bg-purple-700 
          ...
          recommendedUsers.map((user) => (
            ...
            >
              ...
              <button
                ...
                className="text-purple border border-dashed border-purple-500 hover:bg-purple-700 rounded-md py-1 px-2 text-sm font-semibold group transition duration-300"
              >
