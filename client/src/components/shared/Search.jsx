    ...
    <div>
      <div className="relative">
        <input
          ...
          className="h-10 py-1 bg-white border w-full md:w-[660px] rounded-lg text-sm shadow-sm focus:outline-none focus:shadow-outline-purple focus:border-purple-500 transition duration-300 pl-3 pr-10"
          aria-label="Search"
          autoComplete="off"
        />
        {inputValue !== "" && (
        ...
        >
          {loading && (
            <div className="flex items-center justify-center py-2 px-2">
              <MoonLoader size={20} color={"#CB0EFFFF"} />
          ...
          {joinedCommunity && (
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="font-semibold text-md text-purple">
